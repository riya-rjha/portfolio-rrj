...
const Projects = () => {
  ...
  const projects = [
    ...
    {
      name: "CRM: Customer Relationship Management Application",
      url: "https://github.com/riya-rjha/crm-project",
      site: "https://crm-client-topaz.vercel.app/",
      img: BlogApp,
      description:
        "A CRM tool used by Managers to authenticate, ingest customers data, add and store campaigns, send AI Generated Personalized messages to eahc customer & create visually appealing segments and showcase in the form of visual charts to improvise user experience.",
  ...
  return (
    ...
    >
      <h2 className="text-2xl md:text-3xl mb-8 font-bold all-headings tracking-wide text-center dark:text-white underline">
        My Projects
      </h2>
      ...
      {location.pathname === "/project" && (
        <>
          <h2 className="text-2xl md:text-4xl all-headings mb-8 mt-16 font-bold tracking-wide text-center dark:text-white">
            Mini Projects
          </h2>
