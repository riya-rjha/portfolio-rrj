...
const Experience = () => (
  ...
  >
    <h2 className="text-2xl md:text-4xl font-bold mb-8 text-center dark:text-white all-headings">
      My Work Experiences
    </h2>
    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
      <div className="relative bg-gradient-to-r from-purple-100 to-gray-100 p-6 rounded-lg shadow-lg border-l-8 border-purple-800 hover:shadow-xl transition-shadow duration-300">
        <h3 className="text-2xl md:text-4xl font-bold text-green-700 mb-4">
          GeeksForGeeks
        </h3>
        <div className="absolute left-[7%] transform -translate-x-1/2 top-[8rem] h-20 border-l-4 border-purple-600"></div>
      ...
      <div className="relative bg-gradient-to-r from-purple-100 to-gray-100 p-6 rounded-lg shadow-lg border-l-8 border-purple-800 hover:shadow-xl transition-shadow duration-300">
        ...
        </h3>  <div className="absolute left-[7%] transform -translate-x-1/2 top-[8rem] h-20 border-l-4 border-purple-600"></div>
        <div className="relative mt-8">
          <div className="flex items-start space-x-4 mb-8">
            <div className="w-10 h-10 rounded-full bg-gray-800 flex items-center justify-center">
